...
describe('Power', function () {
    ...
    it('raises to a negative integer power', function (done) {
    ...
    it('raises a negative base to an odd integer power', function (done) {
        request.get('/arithmetic?operation=power&operand1=-2&operand2=3')
            .expect(200)
            .end(function (err, res) {
                expect(res.body).to.eql({ result: -8 });
    ...
    it('raises a negative base to an even integer power', function (done) {
        request.get('/arithmetic?operation=power&operand1=-2&operand2=2')
            .expect(200)
            .end(function (err, res) {
    ...
    it('supports fractional exponents on positive base', function (done) {
    ...
    it('supports exponential notation for operands', function (done) {
        request.get('/arithmetic?operation=power&operand1=1.2e1&operand2=1e0')
            .expect(200)
            .end(function (err, res) {
    ...
    it('handles fractional base with negative exponent', function (done) {
